...
namespace PokerHand.DataAccess.Migrations
{
    ...
    [Migration("20210531090332_Added_friends_and_Chats")]
    partial class Added_friends_and_Chats
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasPostgresEnum(null, "country_code", new[] { "none", "us", "ca", "br", "jp", "cn", "in", "kr", "ru", "ir", "iq", "il", "tr", "au", "za", "ae", "es", "it", "pt", "fr", "gb", "de", "pl", "cz", "ua", "se", "fi", "by", "ee", "ch", "no", "is" })
                .HasPostgresEnum(null, "external_provider_name", new[] { "none", "google", "facebook" })
            ...
            modelBuilder.Entity("PokerHand.Common.Entities.Chat.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PokerHand.Common.Entities.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PokerHand.Common.Entities.Chat.Conversation", b =>
                {
                    b.HasOne("PokerHand.Common.Entities.Player", "FirstPlayer")
                        .WithMany("ConversationsFirst")
                        .HasForeignKey("FirstPlayerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PokerHand.Common.Entities.Player", "SecondPlayer")
            ...
            modelBuilder.Entity("PokerHand.Common.Entities.Chat.Message", b =>
                {
                    b.HasOne("PokerHand.Common.Entities.Chat.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("PokerHand.Common.Entities.ExternalLogin", b =>
                {
                    b.HasOne("PokerHand.Common.Entities.Player", "Player")
                        .WithOne("PlayerLogin")
                        .HasForeignKey("PokerHand.Common.Entities.ExternalLogin", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PokerHand.Common.Entities.Player", b =>
                {
                    b.Navigation("ConversationsFirst");

                    b.Navigation("ConversationsSecond");
