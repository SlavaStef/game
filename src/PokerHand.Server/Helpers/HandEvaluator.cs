...
namespace PokerHand.Server.Helpers
{
    public static class HandEvaluator
    {
        ...
        public static HandRank GetPlayerHandRank(List<string[]> playerCards, List<string[]> communityCards)
        {
            // SevenCards = UserPlayerCards Union CardsOnTable
            List<string[]> SevenCards = new List<string[]>(playerCards);
        ...
        private static double EvaluateRankByHighestCards(List<string[]> cards, int excludeCardValue = -1, int excludeCardValue2 = -1, int limitCheck = 7, double normalize = 433175)
        {
            int i = 0;
            double sum = 0;
